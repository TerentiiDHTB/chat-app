export const IconEyeCrossed = (props: { class: string }) =>
    <svg width="64px" height="64px" viewBox="0 0 24 24" class={props.class} fill="none"
            ...
            <g id="style=linear">
                <g id="eye-close">
                    ...
                    <path id="vector_2"
                          ...
                          stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    <path id="vector_3" d="M2 21.0002L22 2.7002" stroke-width="1.5"
